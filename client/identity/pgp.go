...
func CreatePGPEntity(fullName string, email string) (*openpgp.Entity, error) {
	entity, entityErr := openpgp.NewEntity(fullName, "generated by Bolt", email, &packet.Config{})
