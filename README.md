...
> [roadmap](https://github.com/bolt-chat/boltchat/projects) for the progress of this project.

_boltchat_ is intended as a modern replacement for [IRC](https://en.wikipedia.org/wiki/Internet_Relay_Chat).
...
present-day proprietary protocols and chat applications, such as Discord and Slack. _boltchat_ comes with
...
## Roadmap
The project boards for _boltchat_ can be found [here](https://github.com/bolt-chat/boltchat/projects).
